    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-cart-plus"></i> @lang('site.'.$module_name_plural)</li>
            </ol>
        </section>
                        ...
                        <table class="table table-hover">
                            ...
                            @foreach($rows as $index=>$row)
                                <tr>
                                    ...
                                    <td>{{ substr($row->title, 0, 50) }} @if(strlen($row->title) > 50 )...@endif</td>
                                    <td>{{ substr(strip_tags($row->description), 0, 50) }} @if(strlen($row->description) > 50 )...@endif</td>
                                    <td>
