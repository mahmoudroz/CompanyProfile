    ...
    <div class="content-wrapper">
        ...
        <section class="content-header">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-question-circle"></i> @lang('site.'.$module_name_plural)</li>
            </ol>
        </section>
                ...
                <div class="box-body">
                    ...
                    @if($rows->count() > 0)
                        ...
                        <table class="table table-hover">
                            ...
                            <tr>
                                <th>#</th>
                                <th>@lang('site.ar_question')</th>
                                <th>@lang('site.en_question')</th>
                                <th>@lang('site.ar_answer')</th>
                                <th>@lang('site.en_answer')</th>
                            ...
                            @foreach($rows as $index=>$row)
                                <tr>
                                    <td>{{++$index}}</td>
                                    <td>{{substr($row->ar_question, 0, 20)}} @if(strlen($row->ar_question) > 20 )...@endif</td>
                                    <td>{{substr($row->en_question, 0, 20)}} @if(strlen($row->en_question) > 20 )...@endif</td>
                                    <td>{{substr(strip_tags($row->ar_answer), 0, 20)}} @if(strlen(strip_tags($row->ar_answer)) > 20 )...@endif</td>
                                    <td>{{substr(strip_tags($row->en_answer), 0, 20)}} @if(strlen(strip_tags($row->en_answer)) > 20 )...@endif</td>
                                    <td>
